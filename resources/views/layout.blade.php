    ...
    <div class="w-full mb-4">
        ...
        <div class="p-4">
            ...
            <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">My Event</a>
            <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">Event Joined</a>
            <!-- Post description -->
            ...
            <div class="right-section bg-gray-100 dark:bg-gray-800 p-4">
                <!-- Suggest section -->
                <div class="my-10">
                <h5 class="font-bold mb-4">Recommend For You</h5>
                </div>
                <!-- User cards -->
                <div class="w-full mb-4">
                <!-- User card -->
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden mb-4">
                    ...
                    <div class="p-4">
                    <!-- User name -->
                    <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">#DikaGay</a>
                    <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">#DikaGay</a>
                    <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">#DikaGay</a>
                    <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">#DikaGay</a>
                    <a href="#" class="font-bold mb-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent block">#DikaGay</a>
