...
@section('content')
  ...
  <div class="my-10">
  <h5 class="font-bold mb-4">Event</h5>
  </div>

  <div class="mr-20 flex justify-center items-center min-h-screen">
    <div class="block max-w-3xl mx-auto mb-4 bg-white dark:bg-gray-700 rounded-lg shadow-md p-4">
    <a href="#">
      <img class="rounded-t-lg w-full h-60  object-cover" src="./img/Dika.jpg" alt="" />
    </a>
      <div class="p-5">
          <a href="#">
